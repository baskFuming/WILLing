    ...
    public class SlidingTabIndicator extends LinearLayout {
        ...
        private void updateIndicatorPosition() {
            ...
            if (selectedTitle != null && selectedTitle.getWidth() > 0) {
                ...
                if (!MyTabLayout.this.tabIndicatorFullWidth && selectedTitle instanceof TabView) {
                    this.calculateTabViewContentBounds((TabView) selectedTitle, MyTabLayout.this.tabViewContentBounds);
                    left = (int) (left + temp);
...
//                    right = (int) TabLayout.this.tabViewContentBounds.right;
                ...
                if (this.selectionOffset > 0.0F && this.selectedPosition < this.getChildCount() - 1) {
                    ...
                    if (!MyTabLayout.this.tabIndicatorFullWidth && nextTitle instanceof TabView) {
                        this.calculateTabViewContentBounds((TabView) nextTitle, MyTabLayout.this.tabViewContentBounds);
...
//                        nextTitleRight = (int) TabLayout.this.tabViewContentBounds.right;
        ...
        void animateIndicatorToPosition(final int position, int duration) {
            ...
            if (targetView == null) {
                ...
                if (!MyTabLayout.this.tabIndicatorFullWidth && targetView instanceof TabView) {
                    this.calculateTabViewContentBounds((TabView) targetView, MyTabLayout.this.tabViewContentBounds);
